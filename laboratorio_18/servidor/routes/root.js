...
const lab18controller = require('../controllers/Lab18Controller');
...
router.get('^/$|/index(.html)?', isAuth, lab17controller.get);
router.get('^/$|/lab18(.html)?', isAuth, lab18controller.get);
router.get('^/$|/lab13(.html)?', isAuth, lab13controller.get);
